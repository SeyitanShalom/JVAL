        ...
        <AdminPanel title="Admin Login">
          <div className="grid gap-3">
            <div className="rounded-lg border border-slate-200 p-4">
              <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-slate-500">Account model</p>
              <p className="mt-1 text-sm font-bold text-slate-950">Single fixed admin account</p>
            </div>
            <div className="rounded-lg border border-slate-200 p-4">
              <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-slate-500">Environment keys</p>
              <p className="mt-1 text-sm font-bold text-slate-950">ADMIN_EMAIL, ADMIN_PASSWORD_HASH, ADMIN_SESSION_SECRET</p>
            </div>
          </div>
        </AdminPanel>
      </section>
