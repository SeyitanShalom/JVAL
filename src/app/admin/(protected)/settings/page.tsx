        ...
        <AdminPanel title="About Content">
          <form className="grid gap-4">
            <label className="grid gap-2 text-sm font-bold text-slate-700">
              Official name
              <input
                defaultValue="Johnvents Apex League"
                className="h-11 rounded-lg border border-slate-200 px-3 font-semibold outline-none focus:border-red-500 focus:ring-4 focus:ring-red-100"
              />
            </label>
            <label className="grid gap-2 text-sm font-bold text-slate-700">
              Sponsor wording
              <input
                defaultValue="Powered by Johnvents Foods"
                className="h-11 rounded-lg border border-slate-200 px-3 font-semibold outline-none focus:border-red-500 focus:ring-4 focus:ring-red-100"
              />
            </label>
            <label className="grid gap-2 text-sm font-bold text-slate-700">
