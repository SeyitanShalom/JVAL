...
export default async function MatchDetailsPage({
  ...
  return (
    <section className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 py-8 sm:px-6">
      {/* Hero Score Card */}
      <div className="overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-slate-950 to-red-950 shadow-2xl">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-white/10 px-6 py-3 text-[11px] font-bold uppercase tracking-[0.08em] text-red-200">
          <span>
        ...
        <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-4 px-6 py-8 md:px-10">
          ...
          <div className="flex flex-col items-center gap-2">
            <span className="tabular-nums text-4xl font-bold tracking-[0.08em] text-white sm:text-6xl">
              {hasScore
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-t border-slate-200 pt-6">
        <Link
          href="/fixtures"
          className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-xs font-bold text-slate-700 shadow-sm transition hover:border-red-500 hover:text-red-500"
        >
          <FiArrowLeft /> Back to Match Center
        </Link>
        <Link
          href={"/matches/" + match.slug + "/team-sheet"}
          className="inline-flex items-center gap-2 rounded-xl bg-red-500 px-4 py-2.5 text-xs font-bold text-white shadow-sm transition hover:bg-red-600"
        >
